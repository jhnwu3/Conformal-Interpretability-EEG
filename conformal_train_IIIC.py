...
train_loader, test_loader, val_loader, cal_loader = prepare_IIIC_cal_dataloader(batch_size=batch_size, 
...
# save the model
torch.save(lightning_model.model.state_dict(), f"saved_weights/st_transformer_conformal_IIIC_nbs{normalize_by_sample()}.pt")
